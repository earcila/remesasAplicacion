...
import { RemesasComponent } from 'app/entities/remesas/remesas.component';
import { RemesasService } from 'app/entities/remesas/remesas.service';
import { Remesas } from 'app/shared/model/remesas.model';

describe('Component Tests', () => {
    describe('Remesas Management Component', () => {
        let comp: RemesasComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RemesasComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.remesas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
